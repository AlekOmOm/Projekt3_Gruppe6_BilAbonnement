...
public class LejeAftaleServiceTest {
    ...
    public void testOpretLejeAftale() {
        nyLejeAftale = new LejeAftale(brugere.get(0), kundeInfo, biler.get(0), "AbonnementsType1", 1000, "Afhentningssted1", "Afleveringssted1", LocalDate.now(), LocalDate.now().plusDays(7));
